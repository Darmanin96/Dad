...
public class TituloFormacionController implements Initializable {
    @FXML
    ...
    public TituloFormacionController() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/TituloFormacionView.fxml"));
